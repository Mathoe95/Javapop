 ...
 * @author mark_
 */
public class VentanaClienteBusqueda extends javax.swing.JFrame {
     ...
     */
    public VentanaClienteBusqueda(Cliente cli) {
        initComponents();
        BufferedImage image = null;
        try {
            image = ImageIO.read(new File("..\\Javapop\\src\\main\\java\\imagenes\\logotipo.png"));
...
/**
    ...
    /**
     * Metood que busca los productos por categoria , titulo y codigo postal.Si
     * no se introduce alguno de ellos nos avisa. si todo se introduce ,
     * buscamos mediante el metodo de buscar producto y si nos devuelve true
     * entonces los mostramos y si no pues borramos el LisIterator y decimos que
     * no se ha encontrado con esos datos introducidos.
     *
     * @param evt
     */
    ...
    private void alta_barraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alta_barraActionPerformed
        // TODO add your handling code here:
        VentanaAltaProductoCliente v = new VentanaAltaProductoCliente(objcli);
        this.dispose();
        v.setVisible(true);
    ...
    /**
     * Metodo para borrar todos los datos introducidos.
     *
     * @param evt
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaClienteBusqueda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaClienteBusqueda().setVisible(true);
            }
        });
    }
