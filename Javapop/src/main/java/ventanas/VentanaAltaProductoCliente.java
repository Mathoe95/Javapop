 ...
 * @author mark_
 */
public class VentanaAltaProductoCliente extends javax.swing.JFrame {
     ...
     */
    public VentanaAltaProductoCliente() {
        initComponents();
    ...
    /**
     * Constructor con parametro cliente.
     *
     * @param cli cliente que hemos introducido anteriormente.
     */
    public VentanaAltaProductoCliente(Cliente cli) {
        initComponents();
        BufferedImage image = null;
        try {
            image = ImageIO.read(new File("..\\Javapop\\src\\main\\java\\imagenes\\logotipo.png"));
...
/**
     * Nos lleva a la ventana del cliente.
     *
     * @param evt
     */
    private void cerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cerarActionPerformed
        // TODO add your handling code here:
        VentanaCliente v1 = new VentanaCliente(objcli);
        this.dispose();
        v1.setVisible(true);
    }//GEN-LAST:event_cerarActionPerformed
    /**
     * Metodo que comprueba que no este vacio los campos y si no lo estan ,
     * llamamos al metodo de dar de alta del cliente el producto y metemos como
     * parametro el producto instanciado. Despues nos vamos a la ventana del
     * cliente.
     *
     * @param evt
     */
    private void EnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnviarActionPerformed
        ...
        try {
            ...
            if (titulo.getText().isEmpty() || descripcion.getText().isEmpty() || categoria.getText().isEmpty() || estado.getText().isEmpty()
                ...
                objcli.altaProductoCliente(pro1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAltaProductoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAltaProductoCliente().setVisible(true);
            }
        });
    }
