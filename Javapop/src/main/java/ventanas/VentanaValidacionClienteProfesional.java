 ...
 * @author mark_
 */
public class VentanaValidacionClienteProfesional extends javax.swing.JFrame {

    /**
     * Creates new form VentanaValidacion
     */
    public VentanaValidacionClienteProfesional() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ClienteProfesional");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(50, 50, 50)
                        .addComponent(jLabelRegistrarse, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)))
     ...
     * clientes profesionales y si todo coincide entonces nos logeamos como ese
     * usuario y comprobacion pasa a true. Si no se encuentra el usuario y
     * contraseña entonces en el if comprobamos si se ha ecnontrado los datos
     * correctamente y si no pues enotnces el usuario es incorrecto.
     *
     * @param evt
     */
        ...
        try {
            ...
            if (UsuarioJtf.getText().isEmpty() || ContraseñaJtf.getText().isEmpty()) {
                ...
                for (int i = 0; i < Utilidades.getClientesProfesionales().size(); i++) {
                    if (Utilidades.getClientesProfesionales().get(i).getCorreo().equals(UsuarioJtf.getText())) {
                        if (Utilidades.getClientesProfesionales().get(i).getClave().equals(ContraseñaJtf.getText())) {
                            VentanaClienteProfesional cp = new VentanaClienteProfesional(Utilidades.getClientesProfesionales().get(i));
                            cp.setVisible(true);
    ...
    /**
     * Boton que nos envia a la venta de alta de clientes profesionales.
     *
     * @param evt
     */
    private void RegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistroActionPerformed
        // TODO add your handling code here:
        VentanaAltaClienteProfesional v1 = new VentanaAltaClienteProfesional();
        v1.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaValidacionClienteProfesional.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaValidacionClienteProfesional().setVisible(true);
            }
        });
    }
