 ...
 * @author mark_
 */
public class VentanaClienteMisProductos extends javax.swing.JFrame {
     ...
     */
    public VentanaClienteMisProductos() {
        initComponents();
     ...
     */
    public VentanaClienteMisProductos(Cliente cli) {
        initComponents();
        BufferedImage image = null;
        try {
            image = ImageIO.read(new File("..\\Javapop\\src\\main\\java\\imagenes\\logotipo.png"));
...
/**
    ...
    private void urgenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_urgenteActionPerformed
        ...
        if (PanelProductos.urgente.isSelected()) {
            ...
            objpro.productoUrgente(objcli);
            JOptionPane.showMessageDialog(this, "Se ha puesto correctamente como urgente", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
            JOptionPane.showMessageDialog(this, "Se le ha cargado 5€ a la tarjeta:" + objcli.getTarjetaCredito(), "Mensaje", JOptionPane.INFORMATION_MESSAGE);
            JOptionPane.showMessageDialog(this, "Le queda en la cuenta:" + objcli.getSaldo() + "€", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
            if (li.hasNext()) {
                objpro = li.next();
                if (objpro != null) {
                    presenta(objpro);
    ...
    /**
     * Metodo para dar de baja a un producto que tiene el cliente, llamando al
     * metodo del cliente para dar de baja y el parametro del producto a dar de
     * baja.
     *
     * @param evt
     */
    private void bajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bajaActionPerformed
        ...
        if (objpro != null) {
            li.remove();
            objcli.bajaProductoCliente(objpro);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaClienteMisProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaClienteMisProductos().setVisible(true);
            }
        });
    }
